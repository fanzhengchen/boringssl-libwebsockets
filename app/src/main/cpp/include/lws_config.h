...
#define LWS_INSTALL_DATADIR "/Users/fanzhengchen/Desktop/libwebsockets-2.2.1/build_armv7a/android-toolchain-arm/share"
...
#define LWS_BUILD_HASH "fanzhengchen@fanzhengchens-MacBook-Pro.local-"
